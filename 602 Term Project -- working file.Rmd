...
#Next step see how many neighbourhoods each is significantly different than?
#Ex. how many neighbourhoods is ashfield significantly different than?
...
```{r}
lasso.predict = predict(lasso_model, data.frame(listings[2,]), interval = "predict")
lasso.predict
```
